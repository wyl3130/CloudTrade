...
namespace CloudTrade.Domain.OtherExWareHouseItems
{
    [SugarTable("OtherExWareHouseItem", TableDescription = "其他出库项表")]
    public class OtherExWareHouseItem : BaseEntity
    {
        ...
        [SugarColumn(ColumnName = "OtherExWareHouseId", IsNullable = false, ColumnDataType = "uniqueidentifier", ColumnDescription = "关联的出库单据ID")]
        public Guid OtherExWareHouseId { get; set; } // 关联的出库单据ID
