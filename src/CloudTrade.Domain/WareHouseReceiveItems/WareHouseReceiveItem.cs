...
namespace CloudTrade.Domain.WareHouseReceiveItems
{
    [SugarTable("WareHouseReceiveItem", TableDescription = "仓库退料项")]
    public class WareHouseReceiveItem : BaseEntity
    {
        ...
        [SugarColumn(ColumnName = "WareHouseReceiveId", IsNullable = false, ColumnDataType = "uniqueidentifier", ColumnDescription = "关联的仓库领料单据Id")]
        public Guid WareHouseReceiveId { get; set; }  // 关联的仓库领料单据Id
